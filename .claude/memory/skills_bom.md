...
**Note (repo split 2026-07-21):** these BOM files now live in the separate hardware repo github.com/aradanmn/Handheld-MSP430 (at its root), not in this software repo. Run the bom skill against that repo.
