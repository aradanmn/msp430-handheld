...
This wiring's mapping (see [`wiring/phase-3-buttons-shift-register.md`](https://github.com/aradanmn/Handheld-MSP430/blob/main/wiring/phase-3-buttons-shift-register.md)
